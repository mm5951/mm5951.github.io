...
This website contains some sample work as part of the p8105 class on Data Science. More specifically, a dashboard with weather visualizations from the NOAA dataset is available [here](dashboard.html).
...
**Further sample work is publicly available on Meritxell's GitHub account [here](https://github.com/mm5951).**
